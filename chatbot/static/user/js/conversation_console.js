function conversationConsole(){
    return {
        ...
        addConversation(e,i,k){
            let conversation = {"intent":"intent_"+Math.floor(Date.now()).toString(36),"auth":false,"data_fetch":false,"entities":"","statements":["Statement"],"responses":["Response"]}
            if(k != null){
        ...
        addStory(){
            this.stories.push({name:"Story "+(this.stories.length+1),categories:["Category"],conversations:[{"intent":"intent_"+Math.floor(Date.now()).toString(36),"auth":false,"data_fetch":false,"entities":[],"statements":["Statement"],"responses":["Response"]}]});
